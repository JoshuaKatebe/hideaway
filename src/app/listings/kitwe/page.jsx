...
const rooms = [
  {
    id: 1,
    title: "Mindolo Executive Stay",
    price: "K1000",
    location: "Mindolo Miseshi - Kitwe",
    status: "available",
    description: "Comfortable and well-equipped apartment in Mindolo, ideal for business or leisure with easy access to the city.",
    images: ["/Pic7.jpg", "/Pic8.jpg", "/Pic9.jpg"],
    features: ["Queen Size Bed", "Living Area", "Work Desk", "Kitchenette", "Free WiFi"],
    capacity: "2 Guests",
    size: "50 sqm"
  },
  {
    id: 2,
    title: "Miseshi Business Pad",
    price: "K1200",
    location: "Mindolo Miseshi - Kitwe",
    status: "available",
    description: "A modern and functional space designed for the business traveler in Miseshi, close to corporate offices.",
    images: ["/Pic10.jpg", "/Pic11.jpg", "/Pic12.jpg"],
    features: ["Double Bed", "Business Desk", "High-Speed WiFi", "En-suite Bathroom"],
    capacity: "2 Guests",
    size: "40 sqm"
  },
  {
    id: 3,
    title: "Kitwe Explorer's Base",
    price: "K600",
    location: "Mindolo Miseshi - Kitwe",
    status: "unavailable",
    description: "An affordable and comfortable room, a great base for exploring Kitwe and the surrounding mining district.",
    images: ["/Pic13.jpg", "/Pic14.jpg", "/Pic15.jpg"],
    features: ["Single Beds", "Free WiFi", "Shared Kitchen Access", "Close to Amenities"],
    capacity: "2 Guests",
    size: "30 sqm"
  },
  {
    ...
    location: "Mindolo Miseshi - Kitwe",
    status: "unavailable",
    description: "Apartment offering views of the Garden landscape, providing a unique Kitwe experience.",
    images: ["/Pic16.jpg", "/Pic17.jpg", "/Pic18.jpg"],
    features: ["Queen Bed", "Balcony", "Kitchenette", "Living Area"],
    capacity: "2 Guests",
    size: "55 sqm"
  },
  {
    id: 5,
    title: "Mindolo Family Stay",
    price: "K950",
    location: "Mindolo Miseshi - Kitwe",
    status: "available",
    description: "Spacious and comfortable apartment suitable for families visiting or relocating to the Mindolo area.",
    images: ["/Pic13.jpg", "/Pic14.jpg", "/Pic15.jpg"],
  ...
  {
    id: 6,
    title: "Miseshi Compact Studio",
    price: "K800",
    location: "Mindolo Miseshi - Kitwe",
    status: "available",
    description: "A compact and efficient studio apartment in Miseshi, perfect for solo travelers or short stays.",
    images: ["/Pic16.jpg", "/Pic17.jpg", "/Pic18.jpg"],
...
function RoomCard({ room, index }) {
  ...
  return (
    // Wrap the motion.div with a Link component
    <Link href={`/listings/kitwe/${room.id}`} passHref>
    <motion.div
      ref={cardRef}
      // Remove onClick as Link handles navigation
      // onClick={handleCardClick}
      // Remove cursor-pointer as Link provides pointer cursor
      variants={scaleIn}
      initial="hidden"
